...
| 3 | Intermediate p=16/nrep=3 deterministic warm-harness rung | **done / PR pending** | fixture contract + read artifact; `diagnostic_only` because timed REML fits did not converge |
