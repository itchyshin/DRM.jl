...
| 2 | Sparse-first characterization: report-only accounting + warm/order harness + H²/Szymek framing | **done** | Focused test 23/23; warm artifact `warm_comparable`; Rose PASS; PR from `feat/291-reml-sparse-first` |
