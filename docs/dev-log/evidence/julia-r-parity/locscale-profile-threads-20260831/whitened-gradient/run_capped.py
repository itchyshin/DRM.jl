...
stamp=sys.argv[1]
stem=root/f'whitened-gradient-{stamp}'
...
r=dict(command=cmd,script_sha256=hashlib.sha256(body).hexdigest(),wall_seconds=time.monotonic()-t,hard_cap_seconds=60,timed_out=timeout,returncode=rc,pid=p.pid)
