...
res=DRM.Optim.optimize(f,g!,p.nuisance.minimizer,DRM.Optim.LBFGS(linesearch=DRM.Optim.LineSearches.BackTracking()),DRM.Optim.Options(g_tol=1e-8,iterations=200,store_trace=true,extended_trace=true))
