...
stamp=time.strftime('%Y%m%dT%H%M%SZ',time.gmtime());out=base/('polish-'+stamp)
script=base/'polish_probe.jl'; snap=out.with_suffix('.script.jl');snap.write_bytes(script.read_bytes())
