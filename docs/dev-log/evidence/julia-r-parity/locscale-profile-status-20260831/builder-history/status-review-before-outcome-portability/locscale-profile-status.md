...
- [x] G1: module one thread
  CWD: .
  CHECK: python3 /private/tmp/drm-parity-20260830/integration/run_profile_status_module.py 1 final001
  EXPECT: MODULE_PROFILE_STATUS_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/private/tmp/drm-parity-20260830/integration/DRM.jl; path=92301ffe9a62/34 entries; output=MODULE_PROFILE_STATUS_OK | {"started_utc": "2026-08-31T12:50:18.125103+00:00", "ended_utc": "2026-08-31T12:50:52.826869+00:00", "elapsed_seconds": 34.70100366696715, "exit_code": 0, "timed_out": false, "deadline_seconds": 90, "julia_threads
- [x] G2: module four threads
  CWD: .
  CHECK: python3 /private/tmp/drm-parity-20260830/integration/run_profile_status_module.py 4 final002
  EXPECT: MODULE_PROFILE_STATUS_OK
  EVIDENCE: exit=0; shell=/bin/sh; cwd=/private/tmp/drm-parity-20260830/integration/DRM.jl; path=92301ffe9a62/34 entries; output=MODULE_PROFILE_STATUS_OK | {"started_utc": "2026-08-31T12:50:53.192211+00:00", "ended_utc": "2026-08-31T12:51:28.751869+00:00", "elapsed_seconds": 35.559088916983455, "exit_code": 0, "timed_out": false, "deadline_seconds": 90, "julia_thread
- [ ] G3: Rose review of G0–G2 receipts and serial canonical-location-scale scope
  EVIDENCE: pending
