...
`finite-public-006.json` is the current source-stamped public R-to-Julia receipt.
...
001–005 are historical receipts.003introduced independent replay fields and remains
the immutable stopping-diagnostic input.005refreshes final factor source and
the native R regression covariance repair.006 refreshes final prediction source and
transformed uncertainty code; elapsed21.053seconds includes startup. No receipt
