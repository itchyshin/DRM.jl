...
function _ls_inner_rounding_polish(kind, y, η0, ψ0, gidx, G, P, Zη, Zψ,
    ...
    (isfinite(increase) && isfinite(allowance) && 0 < increase <= allowance) ||
...
function _ls_inner_mode(kind, y, η0, ψ0, gidx, G, P,
    ...
    for _ in 1:maxiter
        ...
        (stepped || stagnated) ||
            return a, _ls_hess_chol(kind, y, η0, ψ0, gidx, G, a, P, Zη, Zψ), false
        stagnated && return a, _ls_hess_chol(kind, y, η0, ψ0, gidx, G, a, P, Zη, Zψ), false
    end
