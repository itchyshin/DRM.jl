...
cmd=["julia","--project=docs","--startup-file=no","tools/parity_docs_subset.jl","--build-dir","docs/build/integration-inner-005","--pages-file",str(out/"pages.txt"),"--navigation","production"]
def manifest():
