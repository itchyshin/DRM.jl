...
name=sys.argv[1];names={'neighbours':['test_simulate.jl','test_simulate_scale_conventions.jl'],'scales':['test_simulate_scale_conventions.jl'],'sampler':['test_locscale_bootstrap_simulator.jl'],'refit':[]}[name]
...
script=(b/'refit-b2.jl').read_text()
