...
|---|---:|---:|---:|---:|---|---:|---:|---:|---:|---:|---:|---|---|
| auto_sparse_em | 1.000e-04 | 1 | 0.790 | 0.790 | yes | -3653.063724 | 7.088e-03 | 0.014172 | 0.773001 | 0.173772 | 0.098043 | no | no |
| auto_sparse_em | 1.000e-06 | 1 | 8.715 | 8.715 | no | -3653.056636 | 0.000e+00 | 0.014181 | 0.772964 | 0.174114 | 0.097931 | no | no |
| auto_sparse_em | 1.000e-08 | 1 | 8.682 | 8.682 | no | -3653.056636 | 0.000e+00 | 0.014181 | 0.772964 | 0.174114 | 0.097931 | no | no |

Reference row for coefficient deltas is the highest-logLik row (`g_tol = 1.000e-06`).
...
|---:|---|---:|---|---:|---|---:|---:|---:|---:|---:|---|
| 20 | serial | 1 | auto_sparse_em | 1.000e-04 | yes | 20 | 0 | 34.860 | 1.743 | 35.255 | bootstrap refits used explicit Gaussian algorithm/g_tol controls |
| 20 | threaded | 4 | auto_sparse_em | 1.000e-04 | yes | 20 | 0 | 10.811 | 0.541 | 10.811 | bootstrap refits used explicit Gaussian algorithm/g_tol controls |

Serial/threaded bootstrap speedup on the simulated-refit phase: 3.22x.
