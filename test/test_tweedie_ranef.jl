...
#
# R oracle fixture (test/parity/fixtures/tweedie-mu-ranef/): generated and
# fit by test/parity/fixtures/tweedie-mu-ranef/gen_data.R —
#
...
# to the same optimum; the MEASURED gap (this fixture, both engines
# converged) was: |Δβ| <= 1.4e-4, |Δ log σ| = 1.7e-6, |Δ logit p| = 3.3e-5,
# |Δ sd_id| = 8.9e-4, |Δ loglik| = 0.052. Tolerances below give that margin
# roughly 5-10x headroom, not zero slack.
